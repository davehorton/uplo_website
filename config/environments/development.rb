Uplo::Application.configure do
  ...
  config.action_controller.perform_caching = (ENV['UPLO_CACHING_ENABLED'] == 'true')
  ...
  config.action_mailer.default_url_options = { :host => ENV['UPLO_DOMAIN'] }
