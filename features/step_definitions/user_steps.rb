...
def sign_up(user, confirmed = false)
  visit '/register'
...
When /^I edit my account details$/ do
  ...
  choose("Female")
  fill_in "Twitter", :with => "iamhacker"
  fill_in "Facebook", :with => "iamhacker"
  click_button "Update"
end
...
Then /^I should see an account edited message$/ do
  page.should have_content "Your profile was updated successfully"
end
...
Then /^I should see my profile information$/ do
  ...
  page.should have_content user.gender_string
end
